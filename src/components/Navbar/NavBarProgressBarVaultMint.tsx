...
interface NavBarProgressBarVaultMintProps {
  className: string;
  shouldDisplayLabel?: boolean;
}

/* copied from NavBarProgressBarTotalUSDr component */

export const NavBarProgressBarVaultMint = (data: NavBarProgressBarVaultMintProps) => {
