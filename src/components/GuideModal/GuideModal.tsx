        ...
        <Modal.Body>
          <div className="guidemodal__header">
            ...
            <div className="guidemodal__body">
              ...
              <h6>
                We are thrilled to release the Devnet version of the Ratio platform. We hope this preview into our
              ...
              <h6>
                ...
                can lock $10 worth of any of the tokens (0.1 tokens) in a single deposit and then mint a maximum amount
                of USDr corresponding to the risk factor.
              </h6>
              ...
              <h6>
                In order for a user to withdraw their collateral, their full debt must be paid back, which can be done
                as a single transaction. The user can then withdraw the total amount of collateral locked in their
                vault, also in a single transaction.
              </h6>
            </div>
