...
export const STABLE_POOL_PROGRAM_ID = new PublicKey('8JmAn9gXhkTtsFWZ7hr6Hh4B5CeRxHaieNvHrzrdVCH9');

export const FAUCET_PROGRAM_ID = new PublicKey('6qoqAB1dsRck2opC9FdvsFRVZ48yUWfEFTPZuHBZTQf');
